            ...
            <div class="card mb-4">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-3">
                              ...
                              <input type="date" class="form-control datepicker" name="sales_invoice_date" id="sales_invoice_date">
                            </div>
                ...
                <div class="card-body">
                      ...
                      <table class="table-sm table-bordered" width="100%">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>Grand Total</td>
                                  <td>
                                    <input type="text" name="grand_total" id="grand_total" class="form-control form-control-sm text-right grand_total" readonly>
                                  </td>
                                  <td></td>
                                </tr>
                              </tbody>
                      ...
                      <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                                  <label for="due_date">Due Date(To be delivered on)</label>
                                                  <input type="date" class="form-control datepicker" name="due_date" id="due_date" placeholder="yyyy-mm-dd">
                                       </div> 
                          </div>
                          <div class="form-row">
                              ...
                              <div class="form-group col-md-2">
                                  ...
                                  <select name="sales_invoice_status" id="sales_invoice_status" class="form-control">
                                      ...
                                      <option value="3">Cancelled / Deleted (Soft) </option>
