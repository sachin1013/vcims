...
<body>
    ...
    <h4 style="color: #002366;">Paid Summary</h4>   
    <table style="width: 100%; margin-bottom:100px">
        ...
        <tbody>
            ...
            @foreach ($alldata as $key => $payment)
                <tr>
                    ...
                    <th style="border: 1px solid #002366;padding:7px;">&#x20B9;{{ number_format($payment->paid_amount,2) }}</th>
                     @php
        ...
        <tbody>
            <tr>
                <th colspan="4" style="text-align: right;padding:8px;background: #002366;color:white">Total Paid Amount:</th>
                <th style="border: 1px solid #002366;"><strong>&#x20B9;{{ number_format($total_paid,2) }}</strong></th>
            </tr>
            @php
