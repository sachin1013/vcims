          ...
          <br>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="fas fa-plus-circle mr-1"></i>Edit Purchase</span>
                    <small class="d-sm-block"></small>
                </div>
                <div class="card-body">
                    <form action="../update/{{ $purchase->id }}" method="post" id="Product_form">
                        @csrf 
                        <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="purchase_date">Date</label>
                              <input type="text" class="form-control datepicker" name="purchase_date" value="{{ $purchase->purchase_date }}" id="purchase_date" placeholder="yyyy-mm-dd" readonly>
                            </div>
                            <div class="form-group col-md-4">
                              <label for="purchase_invoice_no">Purchase Invoice No</label>
                              <input type="text" readonly class="form-control" name="purchase_invoice_no" id="purchase_invoice_no" value="{{ $purchase->purchase_invoice_no }}">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="vendor_id">Vendor Name OR </label><!--<button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#openVendorModal" id="open" readonly > Add new vendor</button> -->
                                <select class="form-control select2" name="vendor_id[]" id="vendor_id">
                                    @foreach ($vendor as $vendor)
                                    <option value="{{ $vendor->id }}" @if($purchase->vendor_id == $vendor->id) selected="selected" @endif>{{ $vendor->company_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                <label for="category_id">Category Name OR </label><button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#openCategoryModal" id="open">Add new Category</button> 
                            ...
                            <div class="form-group col-md-4">
                              <label for="product_id">Product Name OR </label><button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#openProductModal" id="open">Add new Product</button> 
                          ...
                          <table class="table-sm table-bordered" width="100%">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <input type="text" name="total_discount" value="{{ $purchase->total_discount }}" id="total_discount" class="form-control form-control-sm text-right total_discount">
                                    <input type="hidden" name="cgst_total" value="{{ $purchase->cgst_total }}" id="cgst_total" class="form-control form-control-sm text-right cgst_total">
                                    <input type="hidden" name="sgst_total" value="{{ $purchase->sgst_total }}" id="sgst_total" class="form-control form-control-sm text-right sgst_total">
                                    <input type="hidden" name="total_qty" value="{{ $purchase->total_qty }}" id="total_qty" class="form-control form-control-sm text-right total_qty">
                                  </td>
                                  <td></td>
                                </tr>
                                <tr>
                                  ...
                                  <td>Grand Total</td>
                                  <td>
                                    <input type="text" name="grand_total" id="grand_total" class="form-control form-control-sm text-right grand_total" value="{{ $purchase->grand_total }}" readonly>
                                  </td>
                                  <td></td>
                                </tr>
                              </tbody>
                        ...
                        <button type="submit" class="btn btn-primary mt-2">Update Purchase Invoice</button>
                      </div>
                    </form>      
                </div>
                            ...
                            <form method="post" action="{{ route('purchase.ajaxaddvendor') }}" id="ajaxaddvendor">
                                ...
                                <div class="modal modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" id="openVendorModal">
                            ...
                            <form method="post" action="{{ route('purchase.ajaxaddproduct') }}" id="ajaxaddproduct">
                                ...
                                <div class="modal modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" id="openProductModal">
                                    <div class="modal-dialog modal-lg" role="document">
                                      <div class="modal-content">
                                        <div class="alert alert-danger" style="display:none"></div>
                                        <div class="modal-header">
                              ...
                              <form method="post" action="{{ route('purchase.ajaxaddcategory') }}" id="ajaxaddcategory">
                                ...
                                <div class="modal modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" id="openCategoryModal">
                                    <div class="modal-dialog modal-lg" role="document">
                                      <div class="modal-content">
                                        <div class="alert alert-danger" style="display:none"></div>
                                        <div class="modal-header">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function totalamountPrice(){
      var sum = $("#grand_total").val();
      var totdiscount = $("#total_discount").val();
      var total_cgst = $("#cgst_total").val();
      var total_sgst = $("#sgst_total").val();
      ...
      $(".discount_amt").each(function(){
        ...
        if(!isNaN(valuedisc) && valuedisc.length != 0){
          totdiscount = parseFloat(totdiscount) + parseFloat(valuedisc);
        }
      });
